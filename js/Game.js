class Game {
  ...
  showLife() {
    push();
    image(lifeImage, 50, height - player.positionY, 20, 20);
    fill("white");
    rect(70, height - player.positionY,185,20);
    fill("red");
    rect(70,  height - player.positionY, player.life, 20);
    noStroke();
    pop();
  ...
  showFuelBar() {
    push();
    image(fuelImage, 50, height - player.positionY - 100, 20, 20);
    fill("white");
    rect(70,height - player.positionY - 100,185,20);
    fill("black");
    rect(70, height - player.positionY - 100, player.fuel, 20);
    noStroke();
    pop();
  }
